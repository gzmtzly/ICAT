...
outfolder = os.path.join("results_FAST", os.path.splitext(filename_script)[0])
outfolder += '.'
...
train_data_pulsar_path = np.load("./file_info/pulsar_file_path.npy")[:697]
train_data_rfi_path = np.load("./file_info/rfi_file_path.npy")[:8603]

test_data_pulsar_path = np.load("./file_info/pulsar_file_path.npy")[930:]
test_data_rfi_path = np.load("./file_info/rfi_file_path.npy")[11461:]
...
print(train_data_path[600])
print(train_data_path[700])

print(test_data_path[200])
print(test_data_path[300])
...
for epoch in range(1, 200):
    ...
    #
    # # con_mat.append(Confu_matir)
    # # np.save(outfolder + '/con_mat.npy', con_mat)
    # print(Confu_matir)
